...
class Profile extends StatelessWidget {
  Profile({super.key, required this.service});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      cardDashboardProfile(
                          AppLocalizations.of(context)!.experience, context,
                          () {
                        Get.to(() => WorkInfo(
                              service: service,
                            ));
                      ...
                      cardDashboardProfile(
                          AppLocalizations.of(context)!.education, context, () {
                        Get.to(() => SchoolInfo(
                              service: service,
                            ));
                      }, () {
                      ...
                      cardDashboardProfile(
                          AppLocalizations.of(context)!.certification_p,
                          context, () {
